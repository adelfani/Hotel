...
<body>
    <div class="container m-5">
        <form method="POST" action="{{ route('admin.store') }}" enctype="multipart/form-data" class="m-5">
            @csrf
            <div class="row mb-3">
                <div class="col">
            ...
            <div class="row">
                ...
                <div class="col mt-5">
                    <input class="form-check-input" type="checkbox" id="flexCheckDefault" name="minibar_beschikbaarheid">
                    <label class="form-check-label me-5" for="flexCheckDefault">
                        Minibar beschikbaarheid
                    </label>
                    <input class="form-check-input" type="checkbox" id="flexCheckDefault" name="bad_beschikbaarheid">
